...
void Vsigdelay___024root__trace_chg_sub_0(Vsigdelay___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgSData(oldp+5,(vlSelf->mic_signal),9);
    bufp->chgSData(oldp+6,(vlSelf->delayed_signal),9);
    bufp->chgSData(oldp+7,(vlSelf->sigdelay__DOT__addr1),9);
    bufp->chgSData(oldp+8,((0x1ffU & ((IData)(vlSelf->sigdelay__DOT__addr1) 
