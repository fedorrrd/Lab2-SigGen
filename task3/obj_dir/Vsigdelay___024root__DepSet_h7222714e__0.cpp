...
VL_INLINE_OPT void Vsigdelay___024root___sequent__TOP__0(Vsigdelay___024root* vlSelf) {
    ...
    // Init
    SData/*8:0*/ __Vdly__sigdelay__DOT__addr1;
    SData/*8:0*/ __Vdlyvdim0__sigdelay__DOT__ram__DOT__ram_array__v0;
    SData/*8:0*/ __Vdlyvval__sigdelay__DOT__ram__DOT__ram_array__v0;
    ...
    if (vlSelf->rst) {
        __Vdly__sigdelay__DOT__addr1 = vlSelf->mic_signal;
    } else if (vlSelf->wr) {
        __Vdly__sigdelay__DOT__addr1 = (0x1ffU & ((IData)(vlSelf->sigdelay__DOT__addr1) 
                                                  + (IData)(vlSelf->mic_signal)));
    }
    if (vlSelf->rd) {
        vlSelf->delayed_signal = vlSelf->sigdelay__DOT__ram__DOT__ram_array
            [(0x1ffU & ((IData)(vlSelf->sigdelay__DOT__addr1) 
                        + (IData)(vlSelf->offset)))];
    }
    if (vlSelf->wr) {
